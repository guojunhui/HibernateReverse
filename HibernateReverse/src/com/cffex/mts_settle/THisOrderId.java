...
/**
 * THisOrderId generated by hbm2java
 */
@Embeddable
public class THisOrderId implements java.io.Serializable {
	...
	public THisOrderId(String tradingDay, String exchId, String orderId) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof THisOrderId))
			return false;
		THisOrderId castOther = (THisOrderId) other;
