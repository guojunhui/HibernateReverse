...
/**
 * TCurrPortfolioPositionId generated by hbm2java
 */
@Embeddable
public class TCurrPortfolioPositionId implements java.io.Serializable {
	...
	public TCurrPortfolioPositionId() {
	}

	public TCurrPortfolioPositionId(String portfolioId, String instrumentId, String hedgeFlag, String direction) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TCurrPortfolioPositionId))
			return false;
		TCurrPortfolioPositionId castOther = (TCurrPortfolioPositionId) other;
