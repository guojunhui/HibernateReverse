...
/**
 * TInstrumentFeeId generated by hbm2java
 */
@Embeddable
public class TInstrumentFeeId implements java.io.Serializable {

	private String instrumentId;
	private String codeType;
	private String hedgeFlag;

	public TInstrumentFeeId() {
	}

	public TInstrumentFeeId(String instrumentId, String codeType, String hedgeFlag) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TInstrumentFeeId))
			return false;
		TInstrumentFeeId castOther = (TInstrumentFeeId) other;
